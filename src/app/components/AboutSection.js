        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <p className="text-sm md:text-base text-(--secondary) leading-relaxed mb-8">
              At Prime Solution, we specialize in Water Damage, Fire Damage and
              Mold Restoration Services for both Residential and Commercial
              Properties in Virginia State, primarily serving the counties of
              Fairfax, Loudoun, Prince William etc.
            </p>

            {/* Testimonial Quote Section */}
            <div className="relative pl-6 border-l-4 border-orange-500 mb-10 bg-(--accent)/30 py-4 pr-4">
              <p className="italic text-sm text-(--foreground) mb-3">
                "When my basement flooded, I called these guys for help. They
                found the leak fast and fixed it efficiently. Dealing with a
                flooded basement can be stressful, but they made it easy. I
                highly recommend their services to anyone."
              </p>
              <h4 className="font-bold text-orange-600 text-sm italic">
                — Jacke Manders
              </h4>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-2">
              ...
              <div className="flex flex-col gap-3">
                ...
                <h3 className="font-extrabold text-lg text-foreground">
                  Fast Response and Quality Results
                </h3>
                <p className="text-xs text-(--secondary)">
                  Our team ensures a rapid response to emergencies, delivering
                  top-quality results to restore your property efficiently.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-3">
                ...
                <p className="text-xs text-(--secondary)">
                  With over 10 branches, we are equipped to handle restoration
