                                ...
                                {/* --- Header Section --- */}
                                            <div className="text-center mb-20">
                                                                ...
                                                                <motion.h1
                                                                                        ...
                                                                                        >
                                                                                        Immediate <span className="text-primary">Dispatch</span>span>
                                                                </motion.h1>motion.h1>
                                            ...
                                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                                                ...
                                                <motion.a
                                                                                ...
                                                                                <div>
                                                                                                                    <p className="text-[9px] font-black uppercase tracking-widest text-primary mb-1">{item.label}</p>p>
                                                                                        ...
                                                                                        <div className="bg-primary p-10 rounded-[50px] text-foreground space-y-4 shadow-2xl relative overflow-hidden group">
                                                                                                                    ...
                                                                                                                    <h4 className="text-2xl font-black uppercase italic leading-none">60 Minute <br /> Arrival Guarantee</h4>h4>
                                                                ...
                                                                <motion.div
                                                                                        ...
                                                                                        <div className="bg-card border border-border p-8 md:p-14 rounded-[50px] shadow-2xl relative">
                                                                                                                    <div className="flex items-center gap-3 mb-12">
                                                                                                                                                    ...
                                                                                                                                                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-secondary">Service Request Protocol</p>p>
                                                                                                                        </div>div>
                                                                                        
                                                                                                                    <form onSubmit={handleSubmit} className="space-y-10">
                                                                                                                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                                                                                                                                                                        <div className="relative">
                                                                                                                                                                                                                                <input required type="text" id="name" value={formData.name} onChange={handleInputChange} placeholder=" "
                                                                                                                                                                                                                                                                                className="peer w-full bg-transparent border-b-2 border-border focus:border-primary py-3 outline-none transition-all font-bold text-foreground" />
                                                                                                                                                                                                                                <label htmlFor="name" className="absolute left-0 -top-5 text-[10px] font-black uppercase tracking-widest text-secondary peer-placeholder-shown:text-sm peer-placeholder-shown:top-3 peer-focus:-top-5 peer-focus:text-primary transition-all">Full Name</label>label>
                                                                                                                                                                                                                            </div>div>
                                                                                                                                                                                        <div className="relative">
                                                                                                                                                                                                                                <input required type="tel" id="phone" value={formData.phone} onChange={handleInputChange} placeholder=" "
                                                                                                                                                                                                                                                                                className="peer w-full bg-transparent border-b-2 border-border focus:border-primary py-3 outline-none transition-all font-bold text-foreground" />
                                                                                                                                                                                                                                <label htmlFor="phone" className="absolute left-0 -top-5 text-[10px] font-black uppercase tracking-widest text-secondary peer-placeholder-shown:text-sm peer-placeholder-shown:top-3 peer-focus:-top-5 peer-focus:text-primary transition-all">Emergency Contact</label>label>
                                                                                                                                                                                                                            </div>div>
                                                                                                                                                        </div>div>
                                                                                                                    
                                                                                                                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                                                                                                                                                                        <div className="space-y-4">
                                                                                                                                                                                                                                <label className="text-[9px] font-black uppercase tracking-widest text-primary ml-1">Restoration Category</label>label>
                                                                                                                                                                                                                                <select required id="category" value={formData.category} onChange={handleCategoryChange}
                                                                                                                                                                                                                                                                                className="w-full bg-accent/40 border border-border/50 px-6 py-5 rounded-2xl outline-none focus:ring-2 focus:ring-primary/20 transition-all font-bold text-xs appearance-none bg-gray-600 text-white">
                                                                                                                                                                                                                                                                            <option value="">Select Category</option>option>
                                                                                                                                                                                                                                                                            {categories.map((cat) => (<option key={cat._id} value={cat._id}>{cat.name}</option>option>))}
                                                                                                                                                                                                                                                                        </select>select>
                                                                                                                                                                                                                            </div>div>
                                                                                                                                        ...
                                                                                                                                        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
                                                                                                                                                                                        <label className="text-[9px] font-black uppercase tracking-widest text-primary ml-1">Specific Problem</label>label>
                                                                                                                                                                                        <select required id="subCategory" value={formData.subCategory} onChange={handleInputChange}
                                                                                                                                                                                                                                                className="w-full bg-accent/40 border border-border/50 px-6 py-5 rounded-2xl outline-none focus:ring-2 focus:ring-primary/20 transition-all font-bold text-xs appearance-none bg-gray-600 text-white">
                                                                                                                                                                                                                                            <option value="">Specific Issue</option>option>
                                                                                                                                                                                                                                            {subCategories.map((sub) => (<option key={sub._id} value={sub._id}>{sub.name}</option>option>))}
                                                                                                                                                                                                                                            <option value="other's">Others</option>option>
                                                                                                                                                                                                                                        </select>select>
                                                                                                                                                    ...
                                                                                                                                                    <div className="space-y-4">
                                                                                                                                                                                        <label className="text-[9px] font-black uppercase tracking-widest text-primary ml-1">Situation Description</label>label>
                                                                                                                                                                                        <textarea required id="message" value={formData.message} onChange={handleInputChange} rows="3"
                                                                                                                                                                                                                                    placeholder="Explain the damage (e.g. water leak, fire soot)..."
                                                                                                                                                                                                                                    className="w-full bg-accent/40 border border-border/50 px-8 py-6 rounded-[30px] outline-none focus:ring-2 focus:ring-primary/20 transition-all font-bold text-sm resize-none" />
                                                                                                                                                        </div>div>
                                                                                                                                                    ...
                                                                                                                                                    <motion.button
                                                                                                                                                                                        ...
                                                                                                                                                                                        >
                                                                                                                                                                                        <span className="ml-10 font-black uppercase tracking-widest text-[10px]">{loading ? "Dispatching..." : "Send Request"}</span>span>
