                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-8 w-fit">
                    {categories.map((cat) => (
                        <a
                            ...
                            className="group relative bg-card/70 backdrop-blur-xl rounded-[40px] p-3 transition-all duration-700 hover:shadow-[0_30px_60px_-15px_rgba(15,23,42,0.1)] hover:-translate-y-3 flex flex-col ring-1 ring-border/50 hover:ring-primary/30 shadow shadow-green-500"
                        >
                            {/* Image Section */}
